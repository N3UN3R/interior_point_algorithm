...
def run_interiorPoint_algorithm(household_data,assets,costMatrix):
   ...
   # A = complete_constraint_matrix(household_data)
    ...
    # algorithm
    interiorPointResults = linprog(c=objective, A_eq=A, b_eq=bNew,
    ...
    return interiorPointResults, runtime, timeForDataPrep
