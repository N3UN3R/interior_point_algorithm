from interior_point_algorithm import run_interiorPoint_algorithm
import csv
...
def main():
    ...
    if numberOfProducers > 0:
        ...
        interiorPointResults, runtime, timeForDataPrep = run_interiorPoint_algorithm(household_data, assets,
                                                                                      costMatrix)
